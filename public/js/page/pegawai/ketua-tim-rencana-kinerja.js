...
$("#btn-edit-tugas").on("click", function (e) {
    ...
    let kategori_pelaksana = $("#edit-pelaksana-tugas").val();
    if (kategori_pelaksana == "Gugus Tugas") {
        kategori_pelaksana = "gt";
    } else if (kategori_pelaksana == "Non Gugus Tugas") {
        kategori_pelaksana = "ngt";
    ...
    let kategori_pelaksana_lama = $("#edit-pelaksana-tugas-lama").val();    
    if (kategori_pelaksana !== kategori_pelaksana_lama) {
        Swal.fire({
            icon: "warning",
            title: "Pelakana Tugas Tidak Sama",
            text: "Anda tidak dapat mengubah jika pelaksana tugas beda! Gunakan cara HAPUS tugas",
...
$("#modal-edit-tugas").on("show.bs.modal", function (e) {
    ...
    let kategori_pelaksana_lama = $(e.relatedTarget).data("pelaksana");
    ...
    $("#edit-pelaksana-tugas-lama").val(kategori_pelaksana_lama);
