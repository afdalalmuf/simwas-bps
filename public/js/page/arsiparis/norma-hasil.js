...
if ($("#table-norma-hasil-laporan").length) {
    table = $("#table-norma-hasil-laporan")
        .dataTable({
            dom: "Bfrtip",
            responsive: false,
            lengthChange: false,
    ...
    $(".dt-buttons").appendTo("#download-button");
} else if ($("#table-norma-hasil-dokumen").length) {
    table = $("#table-norma-hasil-dokumen")
        .dataTable({
            dom: "Bfrtip",
            responsive: false,
            lengthChange: false,
...
$("#table-norma-hasil-laporan").on("search.dt", function () {
    table
...
// restart numbering if data table is filter input is changed
$("#table-norma-hasil-dokumen").on("search.dt", function () {
    table
        .column(0, { search: "applied", order: "applied" })
        .nodes()
        .each(function (cell, i) {
