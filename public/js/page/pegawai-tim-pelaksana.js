    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if(response.data.start_date != null){
                ...
                $("#edit-jadwal").val(response.data.start_date + ' - ' + response.data.end_date );
            } else {
                
                $("#edit-jadwal").val( 'awal - akhir');
            }
...
$("#btn-submit-edit-objek").on("click", function (e) {
    ...
    let date_range = $('#edit-jadwal').val();
    ...
    $.ajax({
        url: `/objek-pengawasan/update_objek`,
        type: "POST",
        cache: false,
        data: {
            _token: token,
