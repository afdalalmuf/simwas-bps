...
class PegawaiKompetensiController extends Controller
{
    ...
    public function index()
    {
        ...
        $pelatihans = RencanaDiklat::where('id_pegawai', auth()->user()->id)
    ...
    public function store(Request $request)
    {
        ...
        if ($request->nama_pelatihan === 'Lainnya') {
            $rules['nama_pelatihan_manual'] = 'required|string';
        }
        ...
        // 🟡 Insert logic here: handle manual input if "Lainnya" is selected
        if($request->nama_pelatihan === 'lainnya') {
            $validateData['nama_pelatihan'] = $request->nama_pelatihan_manual;
        } else {
            $pelatihan = RencanaDiklat::find($request->nama_pelatihan);
            $validateData['nama_pelatihan'] = $pelatihan->name;
        }
    ...
    public function getKategori($bentuk)
    {
        $data = KategoriKompetensi::where('bentuk', $bentuk)->get();
    ...
    public function getRencanaDiklat($id)
    {
