...
class UsulanSuratSrikandiController extends Controller
{
    ...
    public function makeSurat($menimbang, $mengingat, $rencana_id, $untuk, $path_doc, $user)
    {
    ...
    public function store(StoreUsulanSuratSrikandiRequest $request)
    {
        ...
        if ($request->file('file') != null) {
            ...
            $all_pelaksana = PelaksanaTugas::where('id_rencanakerja', $request->rencana_id)
                ->whereIn('id_pegawai', $request->pelaksanaTugas)
                ->get();
            
            $document = $this->makeSurat($request->menimbang, $request->mengingat, $request->rencana_id, $request->untuk, $path_doc, $all_pelaksana);
        }
