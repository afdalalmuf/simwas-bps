...
class SidebarPegawai
{
    ...
    public function compose(View $view): void
    {
        ...
        //dalnis
        $dalnis = PelaksanaTugas::with('user')
            ->where(function ($query) use ($id_pegawai) {
        ...
        $usulanNormaHasilDalnisCountSidebar = NormaHasil::whereIn('user_id', $user_dalnis)
        ...
        $view->with(
            [
                ...
                'dalnis' => $dalnis,
                'usulanNormaHasilDalnisCountSidebar' => $usulanNormaHasilDalnisCountSidebar,
