...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(MasterRole::class, 'role_pegawais', 'id_pegawai', 'id_role');
    }
    
    public function verifications()
    {
        return $this->hasMany(SpjVerification::class, 'verifier_id');
    }

    public function hasRole($roleName)
    {
        return $this->roles->contains('id', $roleName);
    }
    ...
    public function skp()
    {
        return $this->hasMany(UploadSkp::class, 'user_id');
    }
