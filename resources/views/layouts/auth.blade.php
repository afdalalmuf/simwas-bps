...
<head>
    ...
    <meta name="description" content="Sistem Informasi Manajemen Pengawasan Inspektorat Utama Badan Pusat Statistik">
    ...
    <div id="app" class="vh-100 d-flex flex-column">
        ...
        <div class="hero-wrapper">
            ...
            <div style="position: fixed; bottom: 20px; right: 20px; z-index: 1000;">
                <a href="/feedback" class="btn btn-primary" data-toggle="tooltip" data-placement="left" title="Feedback."><i class="fa-solid fa-bullhorn"></i></a>
            </div>
        </div>
