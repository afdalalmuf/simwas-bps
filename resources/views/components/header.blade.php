    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown d-flex justify-content-center align-items-center"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="{{route('auditee.dashboard')}}" class="dropdown-item has-icon">
                    <i class="fas fa-user-shield"></i> Login sebagai Auditi
                </a>
                @endif
                @if (auth()->user()->is_bpkp)
                <a href="{{ route('bpkp.dashboard') }}" class="dropdown-item has-icon">
                    <i class="fas fa-user-shield"></i> Login sebagai BPKP
                </a>
                @endif
            </div>
        </li>
