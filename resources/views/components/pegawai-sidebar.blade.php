        ...
        <ul class="sidebar-menu" style="margin-bottom: 30px">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'rencana-kinerja' ? 'active active-dropdown' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    @if ($dalnis > 0)
                        <li
                            class="{{ Request::is('dalnis/norma-hasil') || Request::is('dalnis/norma-hasil/*') || Request::is('dalnis/norma-hasil/*') ? 'active' : '' }} d-flex justify-content-between">
                            <a class="nav-link" href="/dalnis/norma-hasil"
                                style="display: flex; align-items: center; text-decoration: none;">
                                <span style="margin-right: 10px;">Usulan Norma Hasil Dalnis</span>
                                @if ($usulanNormaHasilDalnisCountSidebar > 0)
                                    <div class="bg-primary sidebar-count">
                                        {{ $usulanNormaHasilDalnisCountSidebar }}
                                    </div>
                                @endif
                            </a>
                        </li>
            ...
            <li class="nav-item dropdown {{ $type_menu === 'realisasi-kinerja' ? 'active active-dropdown' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        class="{{ Request::is('pegawai/laporan-bulanan') || Request::is('pegawai/laporan-bulanan/*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('pegawai.laporan-bulanan.index') }}">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'tugas-tim' ? 'active active-dropdown' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('pegawai/tim') ? 'active' : '' }}">
            ...
            <li class="{{ Request::is('pegawai/upload-skp*') ? 'active' : '' }}">
                <a class="nav-link" href="/pegawai/upload-skp">
            ...
            <li class="menu-header">Pengelolaan SPJ</li>
            <li class="{{ Request::is('pegawai/spj-diklat*') ? 'active' : '' }}">
                <a class="nav-link" href="/pegawai/spj-diklat">
                    <i class="fas fa-money-bills"></i>
                    <span>Perjadin Diklat</span>
                </a>
            </li>
            @if (Auth::user()->hasRole('verifikator-spj') || Auth::user()->hasRole('admin'))
                <li class="{{ Request::is('verifikator-spj/spj-diklat*') ? 'active' : '' }}">
                    <a class="nav-link" href="/verifikator-spj/spj-diklat">
                        <i class="fas fa-clipboard-check"></i>
                        <span>Verifikasi SPJ Diklat</span>
                    </a>
                </li>
            @endif
