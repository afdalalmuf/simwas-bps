<div class="modal fade" id="modal-create-skp-penilaian" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="formPenilaian" enctype="multipart/form-data" class="">
                <div class="modal-body">
                    <input type="hidden" id="create-tahun-penilaian" name="tahun">
                    <input type="hidden" id="create-jenis-penilaian" name="jenis">
                    <input type="hidden" id="create-bulan" name="bulan">
                    <div class="form-group" id="rating-hasil-kerja-tour-guide">
                    ...
                    <div class="form-group" id="rating-perilaku-kerja-tour-guide">
                    ...
                    <div class="form-group" id="predikat-kinerja-tour-guide">
                    ...
                    <div class="form-group" id="dok-skp-tour-guide">
