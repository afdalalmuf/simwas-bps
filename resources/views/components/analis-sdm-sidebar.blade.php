...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('analis-sdm/cek-skp*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('analis-sdm.cek-skp.index') }}">
            ...
            @if (auth()->user()->unit_kerja == '8010')
                <li class="nav-item dropdown {{ $type_menu === 'kompetensi' ? 'active active-dropdown' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li
                            class="{{ Request::is('analis-sdm/kategori*') || Request::is('analis-sdm/jenis*') ? 'active' : '' }}">
                ...
                <li
                    class="nav-item dropdown {{ $type_menu === 'realisasi-jam-kerja' ? 'active active-dropdown' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                ...
                <li class="{{ Request::is('analis-sdm/mph*') ? 'active' : '' }}">
                    <a class="nav-link" href="/analis-sdm/mph">
                        <i class="fas fa-user-gear"></i>
                        <span>Matriks Peran Hasil</span>
                    </a>
                </li>
                <li class="{{ Request::is('analis-sdm/rencana-diklat*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('analis-sdm.rencana-diklat.index') }}">
