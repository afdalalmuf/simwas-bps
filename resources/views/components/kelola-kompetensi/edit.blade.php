        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" class="" name="myeditform" id="myeditform">
                ...
                <div class="modal-body">
                    ...
                    @endif
                    <div class="form-group">
                        <label class="form-label" for="edit-skala">Skala<span class="text-danger">*</span></label>
                        <div class="">
                            <select class="form-control select2 skala" id="edit-skala" name="edit-skala" required>
                                <option value="" disabled selected>Pilih Skala</option>                                
                                    <option value="1">Nasional</option>
                                    <option value="2">Internasional</option>
                            </select>
                            <small id="error-edit-skala" class="text-danger"></small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="edit-bentuk">Bentuk<span class="text-danger">*</span></label>
                        <div class="">
                            <select class="form-control select2 bentuk" id="edit-bentuk" name="edit-bentuk" required>
                                <option value="" disabled selected>Pilih Bentuk</option>                                
                                    <option value="1">Klasikal</option>
                                    <option value="2">Nonklasikal</option>
                            </select>
                            <small id="error-edit-bentuk" class="text-danger"></small>
                        </div>
                    </div>
                    <div class="form-group">
