    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-edit-tugas-label">Form Ubah Tugas Tim Kerja</h5>
            ...
            <form enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="edit-pelaksana-tugas-lama">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="edit-hasil_kerja">Hasil Kerja</label>
                        <div class="">
                            <select  class="form-control select2" name="edit-hasil_kerja" id="edit-hasil_kerja" required>
                            ...
                            <small>Mohon diperhatikan untuk <b>Pelaksana Tugas</b> harus <b>SAMA</b></small>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input disabled type="text" id="edit-unsur" class="form-control" name="edit-unsur"
                                required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input disabled type="text" id="edit-subunsur" class="form-control" name="edit-subunsur"
                                required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input disabled type="text" id="edit-pelaksana-tugas" class="form-control"
                                name="edit-pelaksana-tugas" required>
