                                            ...
                                            <div class="card">
                                                <div class="card-header" id="faqhead1">
                                                    <a href="#" class="btn btn-header-link collapsed"
                                                        data-toggle="collapse" data-target="#faq{{ $loop->iteration }}"
                                                ...
                                                <div id="faq{{ $loop->iteration }}" class="collapse"
                                                    ...
                                                    <div class="card-body"
                                                        ...
                                                        <div
                                                            class="h5 text-dark mb-4 d-flex align-items-center header-card">
                                                            ...
                                                            @if ($proyek->rencanaKerja->count() > 0)
                                                                @foreach ($proyek->rencanaKerja->sortBy('tugas') as $tugas)
                                                                    <li class="font-weight-bold mt-4 h5">
                                                                        <p class="font-weight-bold mt-4 h5">
                                                                            {{ $tugas->tugas }}</p>
                                                                    </li>
                                                                    <table class="">
                                                                        <tr>
                                                                            <th valign=top style="min-width: 64px">Hasil
                                                                                Kerja Tim</th>
                                                                            <td>:</td>
                                                                            <td>{{ $tugas->hasilKerja->nama_hasil_kerja }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th valign=top style="min-width: 70px">Jumlah
                                                                                Anggota</th>
                                                                            <td>:&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:&nbsp;</td>
                                                                            <td>
                                                                                {{ $tugas->pelaksana->sum('jan') +
                                                                                    $tugas->pelaksana->sum('feb') +
                                                                                    $tugas->pelaksana->sum('mar') +
                                                                                    $tugas->pelaksana->sum('apr') +
                                                                                    $tugas->pelaksana->sum('mei') +
                                                                                    $tugas->pelaksana->sum('jun') +
                                                                                    $tugas->pelaksana->sum('jul') +
                                                                                    $tugas->pelaksana->sum('agu') +
                                                                                    $tugas->pelaksana->sum('sep') +
                                                                                    $tugas->pelaksana->sum('okt') +
                                                                                    $tugas->pelaksana->sum('nov') +
                                                                                    $tugas->pelaksana->sum('des') }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th valign=top style="min-width: 70px">Jumlah
                                                                            ...
                                                                            @php
                                                                                $laporan = 0;
                                                                                foreach (
                                                                                    $tugas->objekPengawasan
                                                                                    as $op
                                                                                ) {
                                                                                    $laporan += $op->laporanObjekPengawasan
                                                                                        ->where('status', 1)
                                                                                        ->count();
                                                                                }
                                                                            @endphp
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @php
                                                                                ...
                                                                                foreach (
                                                                                    ...
                                                                                    foreach (
                                                                                        $op->laporanObjekPengawasan->where(
                                                                                            'status',
                                                                                            1,
                                                                                        )
                                                                                        as $laporanop
                                                                                        ...
                                                                                        if (
                                                                                            $laporanop->normaHasil->count() >
                                                                                            0
                                                                                        ) {
                                                                                            foreach (
                                                                                                $laporanop->normaHasil->where(
                                                                                                    'status_norma_hasil',
                                                                                                    'disetujui',
                                                                                                )
                                                                                                as $nh
                                                                        ...
                                                                        <tr>
                                                                            <th valign=top style="min-width: 70px">
                                                                                Persentase Laporan/Dokumen Masuk</th>
                                                                            <td>:&nbsp;</td>
                                                                            @if ($laporan > 0)
                                                                                <td>{{ round(($laporan_masuk / $laporan) * 100, 2) }}%
                                                                                </td>
                                                                            @else
                                                                                <td>0%</td>
                                                                            @endif
                                                                        ...
                                                                        @if (count($tugas->pelaksana) > 0)
                                                                            @foreach ($tugas->pelaksana as $pelaksana)
                                                                                <tr>
                                                                                    ...
                                                                                    ?>
                                                                                    <td>{{ $jabatanPelaksana[$pelaksana->pt_jabatan] }}
                                                                                    </td>
                                                                                    <td>
                                                                                        {{ count($tugas->hasilKerja->masterKinerja) != 0
                                                                                            ? $tugas->hasilKerja->masterKinerja[0]->masterKinerjaPegawai->where('pt_jabatan', $pelaksana->pt_jabatan)->first()->hasil_kerja
                                                                                            : 'Belum Ditentukan' }}
                                                                                    </td>
                                                                                    <td>
                                                                                        {{ $pelaksana->jan +
                                                                                            ...
                                                                                            $pelaksana->des }}
                                                                                        <button
                                                                                            class="btn btn-primary btn-sm btn-edit-pelaksana"
                                                                                            data-toggle="modal"
                                                                                            data-target="#modal-edit-pelaksana"
                                                                                            data-id_peg="{{ $pelaksana->id_pegawai }}"
                                                                                            data-nama_peg="{{ $pelaksana->user->name }}"
                                                                                            data-jan="{{ $pelaksana->jan }}"
                                                                                            data-feb="{{ $pelaksana->feb }}"
                                                                                            data-mar="{{ $pelaksana->mar }}"
                                                                                            data-apr="{{ $pelaksana->apr }}"
                                                                                            data-mei="{{ $pelaksana->mei }}"
                                                                                            data-jun="{{ $pelaksana->jun }}"
                                                                                            data-jul="{{ $pelaksana->jul }}"
                                                                                            data-agu="{{ $pelaksana->agu }}"
                                                                                            data-sep="{{ $pelaksana->sep }}"
                                                                                            data-okt="{{ $pelaksana->okt }}"
                                                                                            data-nov="{{ $pelaksana->nov }}"
                                                                                            data-des="{{ $pelaksana->des }}"
                                                                                            data-jabatan="{{ $pelaksana->pt_jabatan }}">
                                                                                            <i class="fas fa-eye"
                                                                                                style="font-size: 11.8px;"></i>
                                                                                        </button>
                                                                                    </td>
                                                                                </tr>
                                                                            @endforeach
                                                                    ...
                                                                    @if (count($tugas->anggaran))
                                                                        <table class="table table-striped">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th class="rupiah">{{ $totalAnggaran }}
                                                                                </th>
                                                                            </tr>
                                                                        </table>
                                                                    @else
                                                                        <p class="font-italic">Tidak ada anggaran yang
                                                                            ditambahkan</p>
                                                                    @endif
                                                                    <hr>
                                                                            ...
                                                                            @foreach ($tugas->objekPengawasan as $op)
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        {{ $laporan }}
                                                                                        <button
                                                                                            class="btn btn-primary btn-sm btn-show-bulan"
                                                                                            data-toggle="modal"
                                                                                            data-target="#modal-bulan-objek"
                                                                    ...
                                                                    @else
                                                                        <p class="font-italic">Tidak ada laporan yang
                                                                            ditambahkan</p>
                                                                    @endif
                                                                @endforeach
                                                            @else
