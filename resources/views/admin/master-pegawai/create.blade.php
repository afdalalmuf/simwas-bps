                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/admin/master-pegawai" class="needs-validation" novalidate=""
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="name" id="name" required
                                        ...
                                        @foreach ($allPegawai as $key => $value)
                                            <option
                                                value="{{ $value['firstName'] }}{{ empty($value['lastName']) || $value['lastName'] === '-' ? '' : ' ' . $value['lastName'] }}"
                                                data-nip="{{ $value['attributes']['attribute-nip'][0] }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Pangkat" type="text" class="form-control" name="pangkat"
                                        id="pangkat" required value="{{ old('email') }}">
                                    @error('pangkat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    <label for="unit_kerja">Satuan Kerja</label>
                                    <input placeholder="Satuan Kerja" type="text" class="form-control"
                                        name="satuan_kerja" id="satuan_kerja" required value="{{ old('satuan_kerja') }}">
                                    @error('satuan_kerja')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Unit Kerja" type="text" class="form-control" name="unit_kerja"
                                        id="unit_kerja" required value="{{ old('unit_kerja') }}">
                                    @error('unit_kerja')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group d-none">
                                    ...
                                    <input placeholder="Jabatan" type="text" class="form-control" name="jabatan"
                                        id="jabatan" required value="{{ old('jabatan') }}">
                                    @error('jabatan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <hr class="my-1">
                                <div class="form-group">
                                    <label>Sebagai Verifikator SPJ Perjadin Diklat ?</label>
                                    <div class="d-flex align-items-center">
                                        <div class="selectgroup w-50">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="verif_spj_perjadin_diklat" value="1"
                                                    class="selectgroup-input"
                                                    {{ old($key) === '1' ? 'checked="checked"' : '' }}>
                                                <span class="selectgroup-button">Ya</span>
                                            </label>
                                            <label class="selectgroup-item">
                                                <input type="radio" name="verif_spj_perjadin_diklat" value="0"
                                                    class="selectgroup-input1"
                                                    {{ old($key) === '0' ? 'checked="checked"' : '' }}>
                                                <span class="selectgroup-button1">Tidak</span>
                                            </label>
                                        </div>
                                        @error('verif_spj_perjadin_diklat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        @enderror
