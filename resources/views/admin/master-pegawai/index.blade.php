                    ...
                    <form method="post" action="/admin/master-pegawai/import" enctype="multipart/form-data"
                        ...
                        <div class="modal-body">
                            ...
                            <p class="mb-3">
                                ...
                                <br>
                                <a href="{{ asset('document/format-import-pegawai.xlsx') }}"
                                                    ...
                                                    @if ($user->id != auth()->user()->id)
                                                        @if ($user->status == 1)
                                                            <a href="javascript:void(0)"
                                                                ...
                                                                data-placement="top" title="Nonaktifkan Pegawai">
                                                                <i class="fas fa-ban"></i>
                                                            </a>
                                                        @else
                                                            <a href="javascript:void(0)"
                                                                class="btn btn-success activate-btn btn-sm"
                                                                data-id="{{ $user->id }}" data-toggle="tooltip"
                                                                data-placement="top" title="Aktifkan Pegawai">
