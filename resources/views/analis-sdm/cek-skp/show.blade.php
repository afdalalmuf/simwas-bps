...
@section('title', 'Detail Unggah SKP')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Detail Upload SKP</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="/analis-sdm">Dasbor</a></div>
                    <div class="breadcrumb-item active"><a href="/analis-sdm/cek-skp">Cek SKP</a></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-0 pb-0">
                                <div class="col-md-4">
                                    <a class="btn btn-outline-primary" href="/analis-sdm/cek-skp">
                            ...
                            <form method="POST" action="/analis-sdm/cek-skp/{{ $skp->id }}"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $skp->id }}">
                                <input type="hidden" name="jenis" value="{{ $skp->jenis }}">
                                <div class="form-group">
                                    <div class="row">
                                        @if ($skp->bulan == null)
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ ucwords($skp->jenis) }}" readonly>
                                            </div>
                                        @else
                                            <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ $skp->tahun }}"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <iframe src="/{{ $skp->skp_path }}" width="100%" height="500px"
                                        frameborder="0"></iframe>
                                </div>
                                <div class="form-group">
                                    <label for="tgl_upload">Tanggal Unggah</label>
                                    <input type="text" class="form-control" value="{{ $skp->updated_at->format('d M Y') }}" readonly>
                                </div>
                                @if ($skp->bulan !== null)
                                    <div class="form-group">
                                        <div class="row">
                                ...
                                @if ($skp->status == 'Sudah Kirim')
                                    <input type="hidden" name="status" value="Sudah Kirim">
                                    <div class="form-group">
                                        <label class="form-label" for="file">File SKP</label>
                                        <div class="">
                                ...
                                @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control" required>
                                            ...
                                            <option value="Sudah Kirim">Setuju</option>
