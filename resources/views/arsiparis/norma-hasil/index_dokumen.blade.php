                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between flex-wrap my-2 mb-3" style="gap:10px">
                                    ...
                                    <div class="form-group {{ request()->status ? 'd-none' : '' }}"
                                ...
                                <a href="/arsiparis/nh/dokumen/export" class="btn btn-success"><i class="fas fa-file-excel"></i> Excel</a>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped display responsive"
                                        id="table-norma-hasil-dokumen">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            @foreach ($laporan as $lnm)
                                                <tr>
                                                    ...
                                                    <td>{{ isset($lnm->normaHasilDokumen->created_at) ? date('d M Y', strtotime($lnm->normaHasilDokumen->created_at)) : '' }}
                                                    </td>
                                                    </td>
