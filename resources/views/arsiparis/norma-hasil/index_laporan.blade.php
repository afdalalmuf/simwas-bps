                                        ...
                                        <tbody>
                                            @foreach ($laporan as $lnm)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($lnm->jenis == 1)                                                         
                                                            @if ($lnm->normaHasilAccepted->tanggal_norma_hasil < '2025-10-20')
                                                            ...
                                                            @else
                                                                <span class="badge badge-primary">
                                                                    T-{{ $lnm->normaHasilAccepted->nomor_norma_hasil }}/{{ $lnm->normaHasilAccepted->unit_kerja }}/{{ $lnm->normaHasilAccepted->kode_klasifikasi_arsip }}/{{ $lnm->normaHasilAccepted->normaHasil->masterLaporan->kode ?? ($lnm->normaHasilAccepted->kode_norma_hasil ?? '') }}/{{ date('Y', strtotime($lnm->normaHasilAccepted->tanggal_norma_hasil)) }}
                                                                </span>
                                                            @endif
                                                        @else
                                                            <span class="badge badge-primary">
                                                    ...
                                                    <td>{{ $lnm->normaHasilAccepted->normaHasil->masterLaporan->kode ?? '' }}
                                                    </td>
                                                    ...
                                                    <td>{{ isset($lnm->normaHasilAccepted->tanggal_norma_hasil) ? date('d M Y', strtotime($lnm->normaHasilAccepted->tanggal_norma_hasil)) : '' }}
                                                    </td>
                                                    </td>
                                                    ...
                                                    <td>
                                                        @php
                                                            $status =
                                                                $lnm->normaHasilAccepted->status_verifikasi_arsiparis ??
                                                    ...
                                                    text-capitalize"><i
                                                        ...
                                                        {{ $status == 'dibatalkan' ? 'fa-solid fa-ban mr-1' : '' }}
                                                    "></i>{{ $status }}
                                                        </span>
                                                    </td>
                                                    <td>
                                            ...
                                            @foreach ($normaHasilBelumUpload as $normaHasil)
                                                <tr>
                                                    ...
                                                    <td>{{ date('d M Y', strtotime($normaHasil->normaHasil->tanggal)) }}
                                                    </td>
                                                    <td>{{ date('d M Y', strtotime($normaHasil->tanggal_norma_hasil)) }}
                                                    </td>
                                                    <td>
...
@push('scripts')
    ...
    <script src="{{ asset('js') }}/page/arsiparis/norma-hasil.js?v=1.0.2"></script>
@endpush
