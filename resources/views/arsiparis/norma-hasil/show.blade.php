        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    @if ($usulan->jenis == 1)
                        <div class="breadcrumb-item active"><a href="/arsiparis/nh/laporan">Norma Hasil Laporan</a></div>
                    @else
                        <div class="breadcrumb-item active"><a href="/arsiparis/nh/dokumen">Norma Hasil Dokumen</a></div>
                    @endif
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-4 pb-0">
                                <div class="col-md-4">
                                    @if ($usulan->jenis == 1)
                                        <a class="btn btn-outline-primary" href="/arsiparis/nh/laporan">
                                            <i class="fas fa-arrow-left mr-1"></i>Kembali
                                        </a>
                                    @else
                                        <a class="btn btn-outline-primary" href="/arsiparis/nh/dokumen">
                                            <i class="fas fa-arrow-left mr-1"></i>Kembali
                                        </a>
                                    @endif
                                </div>
                            ...
                            @php
                                $status =
                                    $usulan->normaHasilAccepted->status_verifikasi_arsiparis ??
                            ...
                            <table class="mb-4 table table-striped responsive" id="table-show">
                                <tr>
                                    ...
                                    <td>
                                        @if ($usulan->jenis == 1)
                                            @if ($usulan->normaHasilAccepted->normaHasil->tanggal < '2025-10-20')
                                            ...
                                            @else
                                                <span class="badge badge-primary">
                                                    T-{{ $usulan->normaHasilAccepted->nomor_norma_hasil }}/{{ $usulan->normaHasilAccepted->unit_kerja }}/{{ $usulan->normaHasilAccepted->kode_klasifikasi_arsip }}/{{ $usulan->normaHasilAccepted->normaHasil->masterLaporan->kode ?? '' }}/{{ date('Y', strtotime($usulan->normaHasilAccepted->tanggal_norma_hasil)) }}
                                                </span>
                                            @endif
                                        @else
                                            <span class="badge badge-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($usulan->jenis == 1)
                                            <a target="blank"
                                                href="/arsiparis/tim/norma-hasil/viewLaporan/{{ $usulan->normaHasilAccepted->id }}/1"
                                                class="badge btn-primary"><i class="fa fa-download"></i>
                                                Download Norma Hasil Tim</a>
                                        @else
                                            <a target="blank"
                                                href="/arsiparis/tim/norma-hasil/viewLaporan/{{ $usulan->normaHasilDokumen->id }}/2"
                                                class="badge btn-primary"><i class="fa fa-download"></i>
                                                Download Norma Hasil Tim</a>
                                        @endif
                                    </td>
                            ...
                            @elseif ($status == 'disetujui')
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-danger mt-4 ml-2" data-toggle="modal"
                                        data-target="#staticBackdrop">
                                        <i class="fa-regular fa-circle-xmark mr-1"></i>Tolak
                                    </button>
                                </div>
                            @else
                                @if ($usulan->jenis == 1)
                                    @if ($status !== 'dibatalkan')
                                        <div class="d-flex justify-content-end">
                                            <a href="/arsiparis/norma-hasil/edit/{{ $usulan->id }}"
