                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <table class="table table-bordered display responsive text-center"
                                        id="table-inspektur-kinerja" style="background-color: #f6f7f8">
                                        <thead>
                                            <tr>
                                                ...
                                                <tr class="table-bordered">
                                                    ...
                                                    @if (isset($norma_hasil[$bulan->id]))
                                                        @if ($norma_hasil[$bulan->id]->jenis == 1)
                                                            <td>
                                                                @if ($norma_hasil[$bulan->id]->normaHasil->tanggal < '2025-10-20')
                                                                    <span class="badge badge-primary">
                                                                ...
                                                                @else
                                                                    <span class="badge badge-primary">
                                                                        T-{{ $norma_hasil[$bulan->id]->nomor_norma_hasil }}/{{ $norma_hasil[$bulan->id]->unit_kerja }}/{{ $norma_hasil[$bulan->id]->kode_klasifikasi_arsip }}/{{ $norma_hasil[$bulan->id]->normaHasil->masterLaporan->kode ?? '' }}/{{ date('Y', strtotime($norma_hasil[$bulan->id]->tanggal_norma_hasil)) }}
                                                                    </span>
                                                                @endif
                                                            </td>
                                                        @else
                                                        ...
                                                        <td>
                                                            @if ($norma_hasil[$bulan->id]->jenis == 1)
                                                                <a target="blank"
                                                                    ...
                                                                    class="badge btn-primary"><i class="fa fa-eye mr-1"></i>
                                                                    Lihat</a>
                                                            @else
                                                                <a target="blank"
                                                    ...
                                                    @if (isset($kendali_mutu[$bulan->id]->path))
                                                        @if ($kendali_mutu[$bulan->id]->status != 'tidak ada')
                                                            <td>
                                                                ...
                                                                @else
                                                                    <a target="blank"
                                                                        href="{{ $kendali_mutu[$bulan->id]->path }}"
                                                                        class="badge btn-primary"><i
                                                                            class="fa fa-eye mr-1"></i> Lihat</a>
                                                                @endif
                                                            </td>
                                                    ...
                                                    @if (isset($surat_tugas[$bulan->objekPengawasan->id_rencanakerja]))
                                                        @if ($surat_tugas[$bulan->objekPengawasan->id_rencanakerja]->status == 'disetujui')
                                                            <td style="display: none">
                                                                {{ url('/') }}/{{ $surat_tugas[$bulan->objekPengawasan->id_rencanakerja]->suratSrikandi[0]->document_srikandi_pdf_path }}
                                                            </td>
                                                        @else
                                                            <td style="display: none">
                                                                {{ url('/') }}/{{ $surat_tugas[$bulan->objekPengawasan->id_rencanakerja]->directory }}
                                                            </td>
                                                        @endif
                                                    @else
