                                        ...
                                        <div id="test-l-1" class="content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select required
                                                    ...
                                                    <option disabled selected value="">Pilih Pejabat Penanda Tangan
                                                    </option>
                                                    @foreach ($pejabatPenandaTangan as $key => $pejabatPenandaTangan)
                                                        <option {{ old('pejabatPenandaTangan') == $key ? 'selected' : '' }}
                                                            value="{{ $key }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @error('kodeKlasifikasiArsip') is-invalid @enderror"
                                                    ...
                                                    <option disabled selected value="">Pilih Kode Klasifikasi Arsip
                                                    </option>
                                                    @foreach ($kodeKlasifikasiArsip as $kodeKlasifikasiArsip)
                                                        <option
                                                            ...
                                                            {{ $kodeKlasifikasiArsip->kode }}
                                                            {{ $kodeKlasifikasiArsip->uraian }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div
                                                class="form-group
                                            @if ($errors->has('usulanTanggal')) has-error @endif">
                                    ...
                                    <div id="test-l-2" class="content">
                                        <div id="surat-tugas-wrapper">
                                            <div class="form-group">
                                                ...
                                                <select required id="rencana_id" name="rencana_id"
                                                    ...
                                                    @if ($rencanaKerja->isEmpty())
                                                        <option disabled selected value="">Anda belum memiliki tugas
                                                        </option>
                                                    @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <select multiple="multiple" class="form-control select2" id="pelaksana-tugas"
                                                    name="pelaksanaTugas[]">
                                                    </select>                                                
                                                </div>
                                            ...
                                            <div>
                                                <div
                                                    class="form-group
                                        {{-- text area --}}
                                        @if ($errors->has('menimbang')) has-error @endif">
                                                    <label for="menimbang">Menimbang</label>
                                                    <textarea required style="height: 100px" class="form-control @error('menimbang') is-invalid @enderror" id="menimbang"
                                                        name="menimbang" value="{{ old('menimbang') }}"></textarea>
                                            ...
                                            <div>
                                                <div
                                                    class="form-group
                                        @if ($errors->has('mengingat')) has-error @endif">
                                                    <label for="mengingat">Mengingat</label>
                                                    <textarea required style="height: 100px" class="form-control @error('mengingat') is-invalid @enderror"
                                                        id="mengingat" name="mengingat" value="{{ old('mengingat') }}"></textarea>
                                                    <div class="invalid-feedback">Mengingat Harus Diisi</div>
                                                </div>
                                            </div>
                                            <div>
                                                <div
                                                    class="form-group @if ($errors->has('untuk')) has-error @endif">
                                                    <label for="untuk">Untuk</label>
                                                    <textarea required style="height: 100px" class="form-control @error('untuk') is-invalid @enderror" id="untuk"
...
@push('scripts')
    ...
    <script src="{{ asset('js') }}/page/pegawai/usulan-surat-srikandi/create.js?v=1.0.2"></script>
