        ...
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" class="" name="myform" id="myform">
                <div class="modal-body">
                    ...
                    {{-- <div class="form-group">
                        <label class="form-label" for="rk-select">Rencana Kinerja</label>
                        <select class="form-control select2" name="koderk" id="rk-select" required>
                            <option value="" selected disabled>Pilih Rencana Kinerja</option>
                        </select>
                        <small id="error-koderk" class="text-danger"></small>
                    </div> --}}
                    <div class="row">
                        <div class="col">
                            <div class="form-group clockpicker" data-autoclose="true">
                                <label class="form-label" for="start">Jam Mulai</label>
                                <input type="text" name="start" id="start" class="form-control" autocomplete="off" required>
                        ...
                        <div class="col">
                            <div class="form-group clockpicker" data-autoclose="true">
                                ...
                                <input type="text" name="end" id="end" class="form-control" autocomplete="off" required>
