                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="nama" id="nama" class="form-control" accept=".pdf"
                                required>
                            <small>Ukuran Dokumen maks <b>10MB</b></small>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h1 class="h4 text-dark mb-4 header-card" style="margin-top: 100px">Informasi Laporan Norma
                                Hasil</h1>
                            ...
                            @endif --}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ol class="p-0">
                                            <li>Dokumen bisa <b>direupload</b> selama belum diterima oleh Arsiparis</li>
                                            <li>Jika setelah direupload masih muncul dokumen versi sebelumnya, bersihkan
                                                <b>cache browser</b>(CTRL+F5)
                                            </li>
                                            <li>Maksimum upload dokumen <b>10MB</b></li>
                                        </ol>
                                    </td>
                                </tr>
                                @if ($status == 'ditolak')
...
@push('scripts')
    ...
    <script>
        ...
        $('.btn-edit').on("click", function(e) {
            if ($('#nama').val() != '' && $('#nama')[0].files[0].size / 10240 > 10240) {
                $('#error-file').text('Ukuran file maksimal 10MB');
                e.preventDefault();
            }
        });
    </script>
