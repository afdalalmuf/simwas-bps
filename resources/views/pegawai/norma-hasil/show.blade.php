                            ...
                            <table class="mb-4 table table-striped responsive" id="table-show">
                                ...
                                <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif ($usulan->normaHasilAccepted->status_verifikasi_arsiparis == 'disetujui')
                                                <span class="badge badge-success">Norma Hasil Telah Diverifikasi
                                                    Arsiparis</span>
                                            @elseif ($usulan->normaHasilAccepted->status_verifikasi_arsiparis == 'ditolak')
                                    ...
                                    @else
                                        ...
                                        {{ $usulan->status_norma_hasil == 'dibatalkan' ? 'badge-danger' : '' }}
                                ...
                                @endif
                                @if ($usulan->status_norma_hasil == 'dibatalkan')
                                    <tr>
                                        <th>Alasan Nomor Dibatalkan:</th>
                                        <td>{{ $usulan->catatan_norma_hasil }}</td>
                                    </tr>
                                @endif
