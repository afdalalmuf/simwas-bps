                                                ...
                                                @for ($i = 0; $i < $jumlahPelaksana; $i++)
                                                    <tr>
                                                        @if (!isset($rencanaKerja->pelaksana[$i]))
                                                            ...
                                                            <td>
                                                                {{ $rencanaKerja->hasilKerja->masterKinerja[0]->masterKinerjaPegawai->where('pt_jabatan', $i < 2 ? $i + 1 : $i + 2)->first()->hasil_kerja ?? 'Belum tersedia' }}
                                                            </td>
                                                            <td class="font-italic">
                                                                Belum tersedia
                                                            </td>
                                                            <td>
                                                                ...
                                                                @elseif($i == 0 || isset($rencanaKerja->pelaksana[$i - 1]))
                                                                    @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                                        <button
                                                                            class="btn btn-primary btn-sm btn-create-pelaksana"
                                                    ...
                                                    <tr>
                                                        @if (!isset($rencanaKerja->pelaksana[$i]))
                                                            ...
                                                            @elseif ($i == 1)
                                                                <td> PIC</td>
                                                            @endif
                                                            @if (count($rencanaKerja->hasilKerja->masterKinerja) < 1)
                                                                <td>Belum
                                                                    tersedia</td>
                                                            @else
                                                                <td class="font-italic">
                                                                    {{ $rencanaKerja->hasilKerja->masterKinerja[0]->masterKinerjaPegawai->where('pt_jabatan', $i == 0 ? 5 : 3)->first()->hasil_kerja ?? 'Belum tersedia' }}
                                                                </td>
                                                            @endif
                                                            <td class="font-italic"> Belum ditentukan </td>
                                                            <td>
                                        ...
                                        @if (
                                            ...
                                            @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                <div class="d-flex justify-content-end mt-4">
                                                    <button class="btn btn-outline-primary btn-create-pelaksana"
                                                        type="button" data-toggle="modal"
                                                        data-target="#modal-create-pelaksana" data-hasilkerja=2
                                                        data-jabatan=4
                                    ...
                                    <div class="card-body shadow-sm border p-4">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                @foreach ($rencanaKerja->anggaran as $anggaran)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                                <button class="btn btn-warning btn-edit-anggaran btn-sm"
                                                                    type="button" data-toggle="modal"
                                                                    data-target="#modal-edit-anggaran"
                                                                    data-id="{{ $anggaran->id_rkanggaran }}">
                                                                    <i class="fas fa-edit"></i>
                                                                </button>
                                                                <button class="btn btn-danger btn-delete-anggaran btn-sm"
                                                                    type="button"
                                                                    data-id="{{ $anggaran->id_rkanggaran }}">
                                                                    <i class="fas fa-trash"></i>
                                                                </button>
                                        ...
                                        @if (
                                            ($rencanaKerja->kategori_pelaksanatugas == 'gt' && count($rencanaKerja->pelaksana) > 2) ||
                                                ($rencanaKerja->kategori_pelaksanatugas == 'ngt' && count($rencanaKerja->pelaksana) > 0))
                                            @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                @endif @endif @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                    <div class="d-flex justify-content-end mt-4">
                                    ...
                                    <div class="card-body shadow-sm border p-4">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            @foreach ($rencanaKerja->objekPengawasan as $objek)
                                                <tr>
                                                    ...
                                                    <td>{{ $objek->laporanObjekPengawasan->where('status', 1)->count() }}
                                                    </td>
                                                    <td>
                                                        @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                            <button class="btn btn-warning btn-edit-objek btn-sm"
                                                                type="button" data-toggle="modal"
                                                                data-target="#modal-edit-objek"
                                                                data-id="{{ $objek->id_opengawasan }}">
                                                                <i class="fas fa-edit"></i>
                                                            </button>
                                                            <button class="btn btn-danger btn-delete-objek btn-sm"
                                        ...
                                        @if (
                                            ...
                                            @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                @endif @endif @if ($timKerja->status < 2 || $timKerja->status == 5)
                                                    <div class="d-flex justify-content-end mt-4">
                                                        <button id="btn-create-objek" class="btn btn-outline-primary"
                                                            data-toggle="modal" data-target="#modal-create-objek">
                                                            <i class="fa-solid fa-plus mr-1"></i>
                                                            Tambah Objek
                                                        </button>
                                                    </div>
