            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" id="simpanFormBtn"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formTambahRekening">
                            @csrf
                            <input type="text" name="nama_bank" class="form-control" placeholder="Nama Bank" autocomplete="off"
                                required>
                            <input type="text" name="no_rekening" class="form-control mt-2"
                                placeholder="Nomor Rekening" autocomplete="off" required>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3>{{ $diklat->name }}</h3>
                            <h6>{{ $diklat->penyelenggara_diklat->penyelenggara }}</h6>
                            <div id="stepper1" class="bs-stepper">
                                ...
                                <form id="spj-diklat" action="/pegawai/spj-diklat" method="POST"
                                        ...
                                        <div id="test-l-1" class="content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <input type="text" class="form-control me-1 mr-2 ml-2"
                                                        id="input2" style="width: 100px;" required>
                                                    <span class="me-1"> / </span>
                                                    <input type="text" class="form-control me-1 mr-2 ml-2"
                                                        id="input3" style="width: 100px;" required>
                                                    <span class="me-1"> / </span>
                                                    <input type="text" class="form-control me-1 mr-2 ml-2"
                                                        id="input4" style="width: 100px;" required>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_mulai" id="tgl_mulai_st"
                                                    class="form-control" value="{{ $diklat->start_date }}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tgl_selesai" id="tgl_selesai_st"
                                                    class="form-control" value="{{ $diklat->end_date }}" required>
                                                <small>Sesuai dengan surat tugas</small>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div id="test-l-3" class="content">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="ada_hotel"
                                                        id="hotel_tidak" value="tidak" checked>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <input type="file" name="file_hotel" id="file_hotel"
                                                        class="form-control" accept=".pdf">
                                                    <small id="error-file-hotel" class="text-danger"></small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                        ...
                                        <div id="trans-dalam-kota" style="display: none;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    ...
                                                    <small id="error-file-trans-dalkot" class="text-danger"></small>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <small id="catatan-pribadi2" style="display: none;"><i>Cth:
                                                                Screenshot gmaps, struk bensin, struk tol</i></small>
                                                        <small id="error-file-trans-pulang" class="text-danger"></small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="test-l-5" class="content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="ada_berangkat"
                                                        id="berangkat_tidak" value="tidak" checked>
                                        ...
                                        <div class="form-group" id="form-harian-berangkat" style="display: none;">
                                            ...
                                            <input type="number" name="uh_h_1" id="uh_h_1_create"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Apakah mengajukan uang harian H+1 diklat?</label>
                                            <div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="ada_pulang"
                                                        id="pulang_tidak" value="tidak" checked>
                                            ...
                                            <div class="">
                                                <select class="form-control" name="no_rek" id="no_rek">
                                                    ...
                                                    @foreach ($rekening as $r)
                                                        <option value="{{ $r->id_rekening }}">{{ $r->nama_bank }} -
                                                            {{ $r->no_rekening }}</option>
                                                    @endforeach
                                                    <option value="tambah">+ Tambah Rekening Baru</option>
                                                </select>
                                                <small id="error-rekening" class="text-danger"></small>
                                            </div>
                                        </div>
                                        <div class="text-right">
                                            <button type="button" class="btn btn-warning preview-button">
                                    ...
                                    <div id="test-l-6" class="content">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <button type="button" class="btn btn-danger" id="kirimFormBtn" disabled><i
                                                    class="fa-regular fa-paper-plane"></i> Kirim
                                            </button>
                                        </div>
                                    </div>
                                </form>
