...
@section('title', 'Usulan Norma Hasil Dalnis')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Usulan Norma Hasil Dalnis</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="/pegawai/dashboard">Dashboard</a></div>
                    <div class="breadcrumb-item">Usulan Norma Hasil Dalnis</div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            @foreach ($usulan as $un)
                                                <tr>
                                                    ...
                                                    <td>{{ $un->rencanaKerja->proyek->timKerja->nama }}</td>
                                                    <td>
                                                    ...
                                                    @if ($un->status_norma_hasil != 'diperiksa' && $un->status_norma_hasil != 'ditolak')
                                                        <td>
                                                            @if ($un->normaHasilAccepted->status_verifikasi_arsiparis == 'belum unggah')
                                                                <span class="badge badge-dark">Menunggu Upload
                                                                    Laporan</span>
                                                    ...
                                                    {{ $un->status_norma_hasil == 'disetujui' ? 'badge-success' : '' }} text-capitalize">
                                                    ...
                                                    @endif
                                                    <td>
                                                        <a href="/dalnis/norma-hasil/{{ $un->id }}"
