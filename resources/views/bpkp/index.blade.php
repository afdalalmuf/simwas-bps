...
@section('title', 'Dashboard Dokumen SKP')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Dasbor Dokumen SKP</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="/bpkp">Dasbor Dokumen SKP</a></div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            @foreach ($skp_all as $row)
                                                <tr>
                                                    ...
                                                    @endforeach
                                                    {{-- Baris Penetapan --}}
                                                    @if ($row['penetapan'] == null || $row['penetapan']['status'] !== 'Sudah Kirim')
                                                        <td><span class="badge badge-danger">
                                                                Belum Kirim
                                                            </span></td>
                                                    @else
                                                        <td>
                                                            <a href="/bpkp/dashboard/{{ $row['penetapan']['id'] }}"
                                                                class="btn btn-sm btn-link">
                                                                <span class="badge badge-success">
                                                                    Dokumen
                                                                </span>
                                                    ...
                                                    @endif
                                                    {{-- Baris Penilaian --}}
                                                    @if ($row['penilaian'] == null || $row['penilaian']['status'] !== 'Sudah Kirim')
                                                        <td>
                                                    ...
                                                    @else
                                                        <td>
                                                            <a href="/bpkp/dashboard/{{ $row['penilaian']['id'] }}"
                                                                class="btn btn-sm btn-link">
                                                                <span class="badge badge-success">
                                                                    Dokumen
                                                                </span>
